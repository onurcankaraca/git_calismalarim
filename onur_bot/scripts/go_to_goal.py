...
def movebase_client():
    ...
    # Actionlib paketi, önceden alınabilen uzun süreli hedefleri 
    #yürüten sunucular oluşturmak için araçlar sağlar.
    #Ayrıca sunucuya istek göndermek için bir istemci arabirimi sağlar. 
